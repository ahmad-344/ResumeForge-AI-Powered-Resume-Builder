...
Try it now: [https://resume-forge-ai-powered-resume-buil.vercel.app/](#)
...
1. Obtain a free API key from Google AI Studio (sign in with Google and create a key).  
2. Click the **“AI Key”** button in the top bar and paste your key.  
3. AI features will then be enabled.
